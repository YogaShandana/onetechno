...
<section id="page-3" class="h-screen w-full relative overflow-hidden bg-black flex items-center justify-center snap-section">
    <div class="w-full h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-20 py-8 sm:py-0 relative -mt-20">
                                ...
                                <div class="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12">
                                    ...
                                    <div class="flex-1 max-w-3xl">
                                        @if($porto->laptop_image)
                                            <img src="{{ file_exists(public_path('storage/' . $porto->laptop_image)) ? asset('storage/' . $porto->laptop_image) : asset('img/portfolio/' . $porto->laptop_image) }}" 
                                                 ...
                                                 onerror="this.src='{{ asset('img/portfolio/' . $porto->laptop_image) }}'">
                                        @else
                                    ...
                                    <div class="flex-1 max-w-xs">
                                        @if($porto->hp_image)
                                            <img src="{{ file_exists(public_path('storage/' . $porto->hp_image)) ? asset('storage/' . $porto->hp_image) : asset('img/portfolio/' . $porto->hp_image) }}" 
                                                 ...
                                                 @if($porto->url) onclick="window.open('{{ $porto->url }}', '_blank')" @endif
                                                 onerror="this.src='{{ asset('img/portfolio/' . $porto->hp_image) }}'">
                                        @else
